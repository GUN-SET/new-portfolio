...
import profilePix from '../../public/images/profile/developer-pic-2.jpg'
...
const About = () => {
	return (
		<>
			<Head>
				<title>Andrii Soloviov | About Page</title>
			...
			<main className='flex w-full flex-col items-center justify-center dark:text-light'>
				<Layout className='pt-16'>
					...
					<div className='grid w-full grid-cols-8 gap-16'>
						...
						<div className='col-span-3 relative h-max rounded-2xl border-2 border-dark dark:border-light border-solid bg-light dark:bg-dark p-8'>
